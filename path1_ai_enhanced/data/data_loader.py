...
# ============================================================
# 数据源配置 - 优先使用环境变量, 降级到相对路径
# ============================================================
CTA_RESEARCH_ROOT = os.environ.get("CTA_RESEARCH_ROOT", os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "cta_research"))
